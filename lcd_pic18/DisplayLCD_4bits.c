//Na placa EasyPIC v7 estamos usando o modo 4 bits (PORTB)
//o pino R/W está aterrado, portanto o display opera unicamente como escrita!
//********** modo 4 bits ****************************************************
...
void DisplayLCD_Init(){ //modo 4bits ou 8bits
  ...
  //..... COMANDOS PARA INICIALIZAÇÃO DO LCD *********
   ...
   DisplayLCD_Cmd(0x01);
   Delay_ms(1);
  //em breve colocaremos os comandos...*/
#endif
#ifdef LCD4bits
...
#else
  ADCON1 |= 0X0F; //IDEM -> pic18f4520 / 4550
#endif
}
void main() {
